  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-mono selection:bg-primary selection:text-primary-foreground">
      ...
      <header className={`fixed left-0 right-0 z-50 transition-all duration-500 ease-in-out ${isScrolled ? "top-0 px-0" : "top-6 px-4"}`}>
        <div className={`mx-auto bg-gradient-to-b from-white/5 to-black/40 backdrop-blur-md border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] h-16 md:h-24 flex items-center justify-between px-10 transition-all duration-500 ease-in-out ${isScrolled ? "max-w-full rounded-none border-x-0 border-t-0" : "container max-w-[90%] rounded-full"}`}>
          <Link href="/">
