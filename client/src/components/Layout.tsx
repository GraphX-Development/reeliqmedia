  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-mono selection:bg-primary selection:text-primary-foreground">
      ...
      <header className={`fixed left-0 right-0 z-50 transition-all duration-500 ease-in-out ${isScrolled ? "top-0 px-0" : "top-6 px-4"}`}>
        <div className={`mx-auto bg-gradient-to-b from-white/5 to-black/40 backdrop-blur-md border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] h-24 flex items-center justify-between px-10 transition-all duration-500 ease-in-out ${isScrolled ? "max-w-full rounded-none border-x-0 border-t-0" : "container max-w-[90%] rounded-full"}`}>
          <Link href="/">
            <div className="flex items-center gap-2 cursor-pointer group">
              <img 
                src="/images/reel_iq_media_main.png" 
                alt="Reel IQ Media" 
                className="h-16 md:h-24 w-auto transition-transform group-hover:scale-105" style={{width: 'auto'}} 
              />
            </div>
          </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <img src="/images/reel_iq_media_main.png" alt="Reel IQ Media" className="h-12 w-auto" />
              </div>
          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/reeliqmedia/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 bg-muted hover:bg-primary transition-colors flex items-center justify-center rounded-md"
              >
              ...
              {/* TikTok */}
              <a 
                href="https://www.tiktok.com/@reeliqmedia" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 bg-muted hover:bg-primary transition-colors flex items-center justify-center rounded-md"
              >
              ...
              {/* YouTube */}
              <a 
                href="https://www.youtube.com/@ReelIQMedia" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-8 h-8 bg-muted hover:bg-primary transition-colors flex items-center justify-center rounded-md"
              >
